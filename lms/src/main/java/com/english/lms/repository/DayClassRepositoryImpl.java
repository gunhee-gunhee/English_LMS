...
public class DayClassRepositoryImpl implements DayClassRepositoryCustom {
    ...
    public Page<DayClassDTO> findAllRegularDayClassesWithDetailsByDaily(LocalDate classDate, Pageable pageable) {
        ...
        String sql =
            ...
            "WHERE d.class_type = 'regular' AND d.class_date = :classDate " +
            "ORDER BY d.start_time ASC LIMIT :limit OFFSET :offset";

        List<Object[]> rows = entityManager.createNativeQuery(sql)
            .setParameter("classDate", classDate)
            .setParameter("limit", limit)
            .setParameter("offset", offset)
            .getResultList();

        long total = ((Number) entityManager
            .createNativeQuery("SELECT COUNT(*) FROM lms_day_class d WHERE d.class_type = 'regular' AND d.class_date = :classDate")
            .setParameter("classDate", classDate)
